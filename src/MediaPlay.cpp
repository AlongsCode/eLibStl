...
static INT s_dtCmdIndexcommobj_media_play[] = { 77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106 };
...
static ARG_INFO m_media_arg[] =
{
	...
	{"窗口句柄", "要设置的窗口句柄", 0, 0, SDT_INT, 0, ArgMark::AS_NONE},
	{"播放位置", "该参数为播放位置，以毫秒为单位。默认为-1，表示从当前处播放", 0, 0, SDT_INT, -1, ArgMark::AS_HAS_DEFAULT_VALUE},
	{"左声道音量", "范围为0-100，0为静音，100为最大音量。如果本参数被省略或超出范围，则不修改此声道音量。", 0, 0, SDT_SHORT, 0, ArgMark::AS_DEFAULT_VALUE_IS_EMPTY},
	{"右声道音量", "范围为0-100，0为静音，100为最大音量。如果本参数被省略或超出范围，则不修改此声道音量。", 0, 0, SDT_SHORT, 0, ArgMark::AS_DEFAULT_VALUE_IS_EMPTY},
	{"左声道音量", "提供参数数据时只能提供变量。范围为0-100，0为静音，100为最大音量。如果本参数被省略，则不返回此声道音量。", 0, 0, SDT_SHORT, 0, ArgMark::AS_RECEIVE_VAR},
	{"右声道音量", "提供参数数据时只能提供变量。范围为0-100，0为静音，100为最大音量。如果本参数被省略，则不返回此声道音量。", 0, 0, SDT_SHORT, 0, ArgMark::AS_RECEIVE_VAR},
	{"声道类型", "声道类型常量1.左声道,2.右声道3.立体声4.均衡", 0, 0, SDT_INT, 0, ArgMark::AS_NONE},
	{"媒体音量", "需设置媒体音量的大小", 0, 0, SDT_INT, 0, ArgMark::AS_NONE},
	{"播放速度", "并非所有媒体都支持速度调整,1到2000之间的整数。原始速度为1000。2000为原始速度的2倍，500为原始速度的一半。警告:过慢的速度将导致媒体看起来已经停止了", 0, 0, SDT_INT, 0, ArgMark::AS_NONE},
	{"位置", "", 0, 0, SDT_INT, 0, ArgMark::AS_NONE},
	{"是否立即播放", "默认为假", 0, 0, SDT_BOOL, 0, ArgMark::AS_DEFAULT_VALUE_IS_EMPTY},
