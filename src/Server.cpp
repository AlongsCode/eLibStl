...
{
	/*000*/ {"数据到达", "收到数据时执行", _EVENT_OS(OS_ALL) | EV_IS_VER2, 0, 0, DATA_TYPE::_SDT_NULL},
	/*001*/ {"客户进入", "有客户端连接时执行", _EVENT_OS(OS_ALL) | EV_IS_VER2, 0, 0, DATA_TYPE::_SDT_NULL},
	/*002*/ {"客户离开", "有客户端断开时执行", _EVENT_OS(OS_ALL) | EV_IS_VER2, 0, 0, DATA_TYPE::_SDT_NULL},
};
